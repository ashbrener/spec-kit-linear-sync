...
4. **Webhook offer.** Asks whether to drop
   `.github/workflows/spec-kit-linear-sync.yml` (Layer E). The prompt
   is verbatim:
...
- `.github/workflows/spec-kit-linear-sync.yml` written, if Layer E
  was accepted.
...
- If you'll contribute back to spec-kit-linear, read
