...
- [ ] T001 [P] Add a `research.md` ADR fixture set under `tests/fixtures/specs/`
...
- [ ] T002 [P] Unit test `tests/unit/adr_parser.bats` — `parser::adr_records`
...
- [ ] T003 Implement `parser::adr_records <spec_dir>` in `src/parser.sh` —
...
- [ ] T004 [P] Unit test `tests/unit/comment_update.bats` —
...
- [ ] T005 Implement `reconcile::mutate_comment_update` in `src/reconcile.sh` —
...
- [ ] T006 [P] [US1] Unit test `tests/unit/adr_comments_create.bats` —
...
- [ ] T007 [US1] Implement `reconcile::sync_adr_comments <spec_issue_id>
...
- [ ] T008 [US1] Wire `reconcile::sync_adr_comments` into
...
- [ ] T009 [P] [US1] Unit test `tests/unit/adr_comments_absent.bats` — a spec
...
- [ ] T010 [P] [US2] Unit test `tests/unit/adr_comments_idempotent.bats` —
...
- [ ] T011 [P] [US2] Unit test `tests/unit/adr_comments_update.bats` — when an
...
- [ ] T012 [US2] Complete the `reconcile::sync_adr_comments` state machine in
...
- [ ] T013 [P] [US3] Unit test `tests/unit/adr_comments_parity.bats` — assert the
...
- [ ] T014 [P] shellcheck `--shell=bash --severity=style` clean across the
  touched `src/*.sh` (`parser.sh`, `reconcile.sh`); fix findings
- [ ] T015 [P] markdownlint-clean across `specs/008-adr-mirroring/**/*.md`
- [ ] T016 [P] Extend `tests/unit/no-real-identifiers.bats` over the new
  `research.md` ADR fixtures; confirm placeholders only (FR-012)
- [ ] T017 [P] Update `README.md` — a short note that a spec's `research.md`
  decisions are mirrored as ADR comments on the spec Issue (additive; keep the
  auto-sync framing per Principle VII)
- [ ] T018 [P] Update `CHANGELOG.md` (Unreleased: ADR / decision-record mirroring
...
- [ ] T019 Run the exact CI locally (shellcheck `--severity=style` + yamllint +
